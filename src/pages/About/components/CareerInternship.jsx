      ...
      <div className="max-w-3xl">
        ...
        >
          <p className="font-mono text-lg md:text-xl text-[#f9f7f7]/90 leading-relaxed">
            ...
            <span className="text-[#2dd4bf]">technical excellence</span> and{' '}
            <span className="text-[#2dd4bf]">creative innovation</span>.
          </p>

          <p className="font-mono text-base text-[#f9f7f7]/80 leading-relaxed">
